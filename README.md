...
GitHub Actions can test the app, build the Docker image, and push it to GitHub Container Registry. Remote NUCs can then run `docker-compose.prod.yml` and track the published image tag.
